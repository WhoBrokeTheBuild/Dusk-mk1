...
Arc::Map<string, int> Arc::Log::s_InfoOutputs = Map<string, int>();
Arc::Map<string, int> Arc::Log::s_ErrorOutputs = Map<string, int>();

Arc::ArrayList<ostream*> Arc::Log::s_Streams = ArrayList<ostream*>();

void Arc::Log::CloseOutputs( void )
{
...
bool Arc::Log::AddInfoOutput( const string& filename, bool append /*= true */ )
{
...
bool Arc::Log::RemoveInfoOutput( const string& filename )
{
	...
	{
		std::ofstream* pFile = (std::ofstream*)s_Streams[streamInd];
		pFile->close();
		delete pFile;
...
bool Arc::Log::AddErrorOutput( const string& filename, bool append /*= true */ )
{
...
bool Arc::Log::RemoveErrorOutput( const string& filename )
{
...
void Arc::Log::ExtInfo( const string& src, const string& msg, const string& file, const int& line )
{
...
void Arc::Log::ExtError( const string& src, const string& msg, const string& file, const int& line )
{
...
void Arc::Log::ExtInfoFmt( const string& src, const string& fmt, const string& file, const int line, ... )
{
	va_list args;
...
void Arc::Log::ExtErrorFmt( const string& src, const string& fmt, const string& file, const int line, ... )
{
	va_list args;
...
void Arc::Log::Output( std::ostream& stream, const string& type, const string& src, const string& msg, const string& file, const int& line )
{
	clock_t now = clock();
...
string Arc::Log::Format( const string& fmt, va_list args )
{
